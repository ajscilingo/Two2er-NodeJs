...
describe('Running stormpath tests\n', function () {
    ...
    it('Test creating Stormpath account', function testPath(done) {
        var accountData = {
            givenName: 'Homer',
            surname: 'Simpson',
    ...
    it('Test deleting Stormpath account', function testPath(done) {
        var client = new sp.Client({
            apiKey: {
                id: '1CRUFRGX863CDWSZFBLB66JS9',
                secret: '2HoQ5havQ7+tj24VwjfXKtAwPuoF/2W2NuOdSqwCMsU'
        ...
        //Todo: Add assertion to ensure user gone
